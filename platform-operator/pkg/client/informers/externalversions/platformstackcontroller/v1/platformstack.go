...
import (
	...
	v1 "github.com/cloud-ark/kubeplus/platform-operator/pkg/client/listers/platformstackcontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformstackV1().PlatformStacks(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformstackV1().PlatformStacks(namespace).Watch(options)
			},
		},
		&platformstackcontrollerv1.PlatformStack{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *platformStackInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformstackcontrollerv1.PlatformStack{}, f.defaultInformer)
}

func (f *platformStackInformer) Lister() v1.PlatformStackLister {
	return v1.NewPlatformStackLister(f.Informer().GetIndexer())
}
