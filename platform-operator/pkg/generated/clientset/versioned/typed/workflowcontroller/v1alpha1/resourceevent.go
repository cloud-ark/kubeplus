...
func (c *resourceEvents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourceEvent, err error) {
...
func (c *resourceEvents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceEventList, err error) {
...
func (c *resourceEvents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourceEvents) Create(ctx context.Context, resourceEvent *v1alpha1.ResourceEvent, opts v1.CreateOptions) (result *v1alpha1.ResourceEvent, err error) {
	result = &v1alpha1.ResourceEvent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourceevents").
...
func (c *resourceEvents) Update(ctx context.Context, resourceEvent *v1alpha1.ResourceEvent, opts v1.UpdateOptions) (result *v1alpha1.ResourceEvent, err error) {
	result = &v1alpha1.ResourceEvent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourceevents").
...
func (c *resourceEvents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resourceEvents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resourceEvents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceEvent, err error) {
	result = &v1alpha1.ResourceEvent{}
