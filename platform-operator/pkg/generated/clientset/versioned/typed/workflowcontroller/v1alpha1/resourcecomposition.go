...
func (c *resourceCompositions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourceComposition, err error) {
...
func (c *resourceCompositions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceCompositionList, err error) {
...
func (c *resourceCompositions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourceCompositions) Create(ctx context.Context, resourceComposition *v1alpha1.ResourceComposition, opts v1.CreateOptions) (result *v1alpha1.ResourceComposition, err error) {
	result = &v1alpha1.ResourceComposition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcecompositions").
...
func (c *resourceCompositions) Update(ctx context.Context, resourceComposition *v1alpha1.ResourceComposition, opts v1.UpdateOptions) (result *v1alpha1.ResourceComposition, err error) {
	result = &v1alpha1.ResourceComposition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcecompositions").
...
func (c *resourceCompositions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resourceCompositions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resourceCompositions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceComposition, err error) {
	result = &v1alpha1.ResourceComposition{}
