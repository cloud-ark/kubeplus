...
5. **Install KubePlus Operator using the generated provider kubeconfig:**
   ...
   ```sh
   helm install kubeplus "https://github.com/cloud-ark/operatorcharts/blob/master/kubeplus-chart-4.1.2.tgz?raw=true" --kubeconfig=kubeplus-saas-provider.json -n $KUBEPLUS_NS
