...
```
   $ wget https://github.com/cloud-ark/kubeplus/raw/master/kubeplus-kubectl-plugins-1.0.4.tar.gz
   $ gunzip kubeplus-kubectl-plugins-1.0.4.tar.gz
   $ tar -xvf kubeplus-kubectl-plugins-1.0.4.tar
