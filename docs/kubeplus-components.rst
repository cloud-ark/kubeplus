...
Namespace that KubePlus creates for that instance. 
The Namespace defined in the Helm chart will get created just as an object
in the NS that KubePlus creates. But it won't contain any of the actual service instance resources. They will be present in the NS that KubePlus has created.
So defining NS in the Helm chart is superfluous and will lead to confusion.
